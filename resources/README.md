...
| [`demand/semiconductor-margins.md`](demand/semiconductor-margins.md) | `SEM` | Where a specialty fab actually sits: Silex's balance sheet and return on assets from its IPO prospectus, the whole distribution of operating margin, asset turnover and capital intensity across every SEC filer in SIC 3674 and four neighbouring codes, the named pure-play foundry peer group from its own filings, and the finding that capital intensity does **not** explain semiconductor margins |
