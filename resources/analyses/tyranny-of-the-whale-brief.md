...
2. **Finance papers.** Partly done. Dhaliwal et al. and Campello & Gao are verified (FIN-2, FIN-3), and the cost-of-capital mechanism is added to `WHY.md` §3. Patatoukas (FIN-5) is still only Partial, because every accessible copy of the abstract is blocked. On 2026-09-14 the owner decided not to pursue it, so it won't be added to `WHY.md`.
