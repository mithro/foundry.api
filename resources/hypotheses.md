...
- **Challenges:**
  ...
  - **LN-14: building capacity costs 13× as much per job as buying it.** Across ten US sites the capital cost per job runs from $98,214 to $5,357,143 (**54.5×**). The two cheapest are both purchases of an operating fab from a seller who wanted out, and they agree to within 4% eight years apart; the eight build-or-tool rows average **$1,300,816 a job**. Whatever a long tail can pay for, it is not $1.3m of capital per job
