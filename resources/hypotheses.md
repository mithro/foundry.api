...
- **Challenges:**
  ...
  - **LNI-16: the clearest counter-example found.** Pragmatic Semiconductor built the fab this hypothesis asks for — flexible ICs, "breakthrough low cost of customisation and rapid production cycles", the UK's first 300 mm line, opened by the Princess Royal with a promise of 500 jobs — and after £287m of equity and 357 staff it billed **£901,000** in 2025, down from £1.69m. The long tail did not turn up
  - **LNI-4 to LNI-11: capital per job is flat across two orders of magnitude of fab size, at €650,000–€935,000 for small Western fabs** (Bromont €654k, Edmonton €779k, Clas-SiC €903k, Pragmatic €935k), against €1.43m for a billion-euro Bosch fab and €2.35m for ams OSRAM. Being small does not make the capital cheaper per person
...
- **Supports:**
  ...
  - **SEM-1, SEM-2: Silex's balance sheet finishes the LNI-17 story, and it is better than the margin suggested.** Its IPO prospectus prints **SEK 2,246m of total assets**, so asset turnover is 1,385 ÷ 2,246 = **0.617×** and return on assets is 368 ÷ 2,246 = **16.38%** on the group figure (13.98% on the operating-company figure), against a median of **0.71%** across 73 SEC filers in SIC 3674. **And it earns that at "approximately 60 percent" utilisation**, stated three times in the prospectus, with the company's own claim of "approximately 100 percent additional revenue" available from the same plant. The whole fab cost **SEK 1.9 billion** of cumulative capital expenditure since 2003 — about USD 194m — against SEK 368m a year of operating profit
  - **SWM-2, SWM-3, SWM-6: measured against the whole population of US-listed software filers, the MEMS foundry wins on the measure that actually compares businesses of different capital intensity.** Silex's 22.67% operating margin sits at the **89.1st percentile** of SIC 7372 Services-Prepackaged Software (n = 211, CY2025, built from the SEC's XBRL frames API) and its return on assets of 13.98% at the **92.4th**; on the group's own operating profit of SEK 368m the two figures are the **91.0th** and **94.8th**. The median SIC 7372 filer earns **−4.5%**; the revenue-weighted aggregate earns **27.22%** on an asset turnover of 0.416, a return on assets of **11.33%**, against Silex's 0.6167 and 13.98–16.38%. **To match the software industry's aggregate return on assets, a fab with Silex's balance sheet would need an operating margin of 18.38% — 11.33% ÷ 0.6167. It has 22.67%.** Software beats it only at the top: AWS would require 29.29%, Microsoft 33.66%, Adobe 47.87%. Two things inflate the figure usually quoted against a fab — it is non-GAAP (median gap **22.6 percentage points** across eight companies' own reconciliations, `SWM-5`) and it is revenue-weighted rather than typical
...
- **Challenges:**
  - **SEM-3, SEM-4, SEM-8: Silex is an outlier, not a template, and this hypothesis should not plan on 22.7%.** Against every SEC filer in SIC 3674 with revenue over $10m (n = 73), the **median operating margin is 1.48%** and the median return on assets is **0.71%**; Silex sits at the **82nd** percentile (89th on the group figure). Among ten listed pure-play and specialty foundries read from their own filings, **only TSMC beats it**, the peer median is **12.07%** on margin and **4.29%** on assets, and **three of the ten lost money in FY2025** (SkyWater −0.58%, Intel −4.19%, Powerchip −15.31%). The defensible planning figure from this evidence is the peer median, not Silex's
  - **SEM-6: the same fab, consolidated by its Chinese parent, sat inside a group that lost money.** Beijing SWAYSURE's 2024 annual report prints total operating revenue of **CNY 1,204,715,636.91** and an operating loss of **CNY (254,276,329.43)** — **−21.11%** — in the year Silex alone earned SEK 339m (+27.65%). R&D was **37.75%** of group revenue and construction in progress **12.71%** of total assets: a second fab being built. **A running fab makes money; the group building the next one does not.** The two sets of accounts reconcile to 1.19% on revenue, so this is the same business seen twice
  - **LNI-16: Pragmatic Semiconductor's audited 2025 accounts.** A fab built deliberately for cheap, fast, small-batch, highly customisable chips — the product this hypothesis describes — has raised **£287.0m of equity** (£60m of it from a state development bank), employs **357** people, holds **£95.0m** of plant, and turned over **£901,000** in 2025, **down** from £1,693,000, with three customers each over 10% of that, a £64.9m loss before tax, £153m of carried-forward tax losses and a **material uncertainty over going concern**. Revenue is **2.4% of payroll**; asset turnover is **0.0095×**
  - **LNI-5: Clas-SiC Wafer Fab, the UK's only commercial SiC foundry, states in its audited strategic report that it prioritises "customers needing rapid prototyping" and "cost effective, low-rate production" — and made a gross loss of −8.6% on £8.35m of turnover** with 76 employees, £32.1m of gross fixed assets and £59.0m of equity raised
  - **LNI-4, LNI-6: capacity is bought with equipment, not people.** LFoundry Avezzano's €40m expansion created **13** permanent jobs against 30 retirements — a net fall of 17 — i.e. **€3.08m per job created**. X-FAB Dresden's US$43.5m expansion put **92% into tools and 8% into the building**
  ...
  - **LN-7: the same company reported a high-mix segment and an anchor-customer segment side by side, and only the anchor-customer one made money.** SkyWater's FY2025 10-K splits Legacy SkyWater (Bloomington + Kissimmee, "highly customized projects in a low-volume research and development environment") from SkyWater Texas (Fab 25, one customer on a take-or-pay). Legacy: **$(34,496) thousand operating loss on $266,847 thousand of revenue, −12.93%**. Texas: **+$31,920 thousand on $175,292 thousand, +18.21%**. Direct fab labour is almost identical in the two (29.97% against 30.24% of revenue); **the difference is SG&A, 25.02% against 4.63%** — which is the cost-to-serve H6 assumes away, measured inside one wafer fab. Caveats are real and are set out at full strength in the entry (Texas is six months, its revenue unwinds a $120m off-market supply contract, and corporate SG&A sits in the Legacy column) but the entry works through each and shows that −12.93% stays negative under all four
  - **LN-14, LN-17, LN-18: building capacity costs 15× as much per job, and 9× as much per wafer start, as buying it.** Across eleven US sites the capital cost per job runs from $75,000 to $5,357,143 (**71×**). The four cheapest are all purchases of an operating fab from a seller who wanted out — **$75,000** (SkyWater/Cypress Bloomington, 2017), **$80,000** (Tower/Maxim San Antonio, 2016), **$86,500** (SkyWater/Infineon Fab 25, 2025), **$98,214** (Akoustis Canandaigua, 2017) — a 31% band across nine years, four states and two wafer sizes, mean **$84,929**; the eight build-or-tool rows average **$1,300,816 a job**. On capacity rather than jobs the same split appears independently: three purchases average **$2,110 per wafer-start-per-month** against **$18,510** for two build/expand projects. Whatever a long tail can pay for, it is not $1.3m of capital per job — but $85k a job, for a fab somebody else is exiting, is a different question
  - **`fab-local-news.md` § "Capital per wafer start" — the long tail's problem is volume, not price, and the arithmetic is now closed.** The whole worldwide unsubsidised open-shuttle sector took **$931,158 in 2025** (`PAY-8`): **32 years** of that to fund the $30m purchase of the cheapest fab in the file, **564 years** to fund Polar's $525m build. It is not a pricing problem — the tail pays **$9,333 per 200 mm wafer equivalent** through wafer.space and on the order of **€65,000** per shuttle through Tiny Tapeout, against the **$1,200 per wafer** SkyWater's Bloomington fab actually earned in FY2021 (156,000 wafers/yr × 87% utilisation ÷ $162.8m revenue). It is a volume problem: **the entire recorded die area of that sector, over its whole existence, is about two hours of one small fab's capacity.** What pays for a fab is **1,560 customers at 100 wafers a year**, and at that customer size the capital is **$19,231 per customer if bought** or **$218,750 if built** — 6.4% and 72.9% of one year of that customer's spend. **The capital is not the obstacle; finding customers who buy wafers rather than tape-outs is**
  ...
  - **MOS-3 / PRD-8: the gap between the traditional brokers and the new providers is not in people, it is in batch size — and the decomposition closes exactly.** The per-head claim made earlier was **withdrawn** after `PRD-1`…`PRD-6` tested it: MOSIS's series is **62.2 → 127.7 → 148.5 → 89.5 → 62.3 → 49.8** designs per head, so 148.5 was the *maximum*, and its last measured year is 49.8; Europractice corrected for the three non-fabrication contacts is **47.1** (`PRD-5`), i.e. **1.06×**, and CMC re-based on its own 19.1–34.0% fabrication share of expenditure is **10.9–26.3**, not 5.0 (`PRD-6`). **The 29.7× figure is dead and must not be used.** What survives is `PRD-8`: MOSIS put **32.8 designs on every run**, Europractice's 2026 schedule offers 248 technology-and-date slots for 753 designs = **3.04 per slot**, and designs/head = (designs per run) × (runs per head) closes on both — 32.8 × 1.52 = 49.8, 3.04 × 15.5 = 47.1. **The modern broker runs ten times as many shuttle events per person and puts eleven times fewer designs on each; they cancel.** Tiny Tapeout runs **124.3 designs per shuttle**, 40.9× Europractice and 3.8× MOSIS's best. Full working in [`analyses/designs-per-head.md`](analyses/designs-per-head.md)
...
- **PAY-4: Tiny Tapeout's best-documented shuttle earned $16,600.** TT04 ran ten weeks, drew 143 projects from over 30 countries, and sold 235 tiles and 97 boards — against a chipIgnite slot costing $9,750 at the time. **PAY-6** puts the whole programme at roughly $0.6m–$1.0m of gross revenue over five years
  ...
  - **SWM-7: the cloud analogy this project leans on has stopped being an asset-light analogy.** AWS spent **74.96% of its 2025 net sales** on property and equipment ($96,496m of additions on $128,725m of segment sales) and carries net plant worth **147.64%** of a year's revenue; Oracle's net plant is **148.40%** of revenue and Microsoft's FY2026 capex **34.94%**. Each of those three exceeds TSMC (33.03% capex, 111.77% net plant), and AWS is **5.32× more capex-intensive per dollar of revenue than Silex** (74.96 ÷ 14.08). CoreWeave, which the SEC classifies as *Services-Prepackaged Software*, spent **200.92% of its revenue** on plant in 2025. The median SIC 7372 filer still spends **0.9%**, so the asset-light claim holds for a typical software company and fails for the ones the "AWS of silicon" framing actually invokes
...
- **Challenges:**
  ...
  - **SEM-5: the peer with five times the customer count earns a third of the margin.** X-FAB's *Annual Report 2025* says it serves "**>400 customers worldwide**" from six fabs — against Silex's 85 from one — and in the same document that "X-FAB's largest customer, Melexis, accounted for **43%** of the Group's revenue in 2025, while the Group's top three customers accounted for 53% of revenue and its top five customers accounted for 58%". X-FAB earned an **8.78%** operating margin and a **3.93%** return on assets; Silex earned 26.57% and 16.38%. **More customers, more concentration on the largest, and a third of the profitability.** In the only pair of directly comparable listed specialty foundries that both publish the numbers, H7's mechanism runs backwards
...
- **Challenges:**
  - **LNI-12, LNI-13: openness and published prices have not made an MPW self-sustaining in the UK either.** CORNERSTONE — "an open-source, licence-free silicon photonics prototyping foundry" with a fully published price list — told EPSRC in 2020 that the capability "will be self-sustaining, with users paying for the service" from December 2019, and has taken **£14,829,718** of further EPSRC money since, on top of £2,267,121 before: **£17,096,839** in total to 2029, all `INCOME_ACTUAL` in Gateway to Research. Public subsidy per design is **£5,900–£19,000**, against a £12,790 list price for a passive SOI cell, and UK universities and first-time UK SMEs are given a further **50% off**. This is the MOSIS pattern (`MOS-8`, `SMB-5`) repeating in the 2020s
