...
- **Challenges:**
  ...
  - **MOS-3: staffing is not what makes these services expensive — and this cuts against the automation reading.** ISI's own annual reports to DARPA give MOSIS's head count as **12 (1983), 11 (1984), 20 (1985), 27 (1986/87)**, at **128, 149, 90 and 62 designs per head**. MOSIS in 1984 was **3.7× more productive per head than Europractice is today** and **29.7× more than CMC** — and it *still* needed ≈$3.0m/yr of facility-and-staff money against a $400 ticket. Automation was not what made MOSIS cheap; the subsidy was
