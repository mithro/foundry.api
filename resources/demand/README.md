...
| [`programme-funding-deep.md`](programme-funding-deep.md) | `FUNDX-1` … `FUNDX-7` | The follow-up: what the money buys, and how much of it is people. CMC's five years of audited financial statements (which correct `FUND-7` and `FUND-9`), the CAD $120m FABrIC contribution, the FP7 publishable summaries filed with the Commission, the missing EUROPRACTICE IC3 grant, a staff census from the activity reports, CMC's 2018 near-closure, and the Chips JU's €1.23bn portfolio. Ends with a head-count and payroll table, a funding table, cost per design recomputed, and a blocked-sources list. Runs its own number sequence |
